...
// import { useState,isTaskOpen,setIsTaskOpen } from "react";
...
//             <ViewToggle onAddTaskClick={() => CreateTask } />
...
function HomePage() {
  const [tasks, setTasks] = useState([]); 
  // 1. Modal kholne aur band karne ke liye State
  const [isTaskOpen, setIsTaskOpen] = useState(false);
    ...
    <div className="min-h-screen w-screen h-flex overflow-hidden relative ">
      ...
      <div className="flex ">
        ...
        <div className=" md:p-8 space-y-6 bg-gray-300 flex-1 overflow-y-auto w-full pb-32 h-screen bg-linear-to-br from-blue-400 to-sky-300 ">  
          ...
          <div className="flex justify-between">
            <p>Manage your tasks and track your daily progress.</p>
            {/* 2. Button click hone par isTaskOpen true ho jayega */}
            <ViewToggle onAddTaskClick={() => setIsTaskOpen(true)} />
          </div>
      ...
      {/* 3. Jab isTaskOpen 'true' hoga, tabhi CreateTask modal screen par dikhega */}
      {isTaskOpen && (
        <CreateTask 
